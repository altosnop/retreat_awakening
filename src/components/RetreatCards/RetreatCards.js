    ...
    <div className="container">
      ...
      <div className="cards_wrapper">
        ...
        <div className="retreat_card">
          ...
          <p>
            Плавать в чистейшем море, загорать, отдыхать и наполняться бодростью
            на год вперёд
          </p>
        </div>
        <div className="retreat_card">
          <img src={Heart} alt="yacht" />
          <p>Настраивать правильную работу всех наших органов и систем. Повышать адаптивность тела и свою стрессоустойчивость</p>
        </div>
        <div className="retreat_card">
          <img src={Lotus} alt="salad" />
          <p>Заниматься энергетическими практиками и медитациями, а также получать инициации на привлечение изобилия во все аспекты нашей жизни</p>
        </div>
        <div className="retreat_card">
        ...
        <div className="retreat_card">
          ...
          <p>
            Заряжать амулеты на здоровье, успешность, уверенность в себе и свою
            самореализацию
          </p>
        </div>
        </Fade>
      ...
      <div className="cards_wrapper">
        ...
        <div className="second_card">
          ...
          <p>Нас ждет купание в затерянных лагунах, медитативные практики на соединение со стихиями Земли и вкусный обед на борту. Поездка включена в стоимость ретрита.</p>
        </div>
        <div className="second_card">
          <img src={Consult} alt="yacht"/>
          <h3>Личные консультации и инициации в эзотерические практики</h3>
          <p>В свободное от занятий время вы сможете пройти индивидуальную сессию у Марго и Наталии. Варианты и стоимость услуг смотрите в разделе Дополнительные услуги (ниже).</p>
        </div>
        <div className="second_card">
          <img src={Communicate} alt="yacht"/>
          <h3>Общение с единомышленниками</h3>
          <p>Сложно соблюдать режим дня, правильно питаться и работать над собой в одиночку? В компании людей на одной волне с вами – это легко и приятно! Каждый участник сможет раскрыться и почувствует поддержку всей группы в доверительной атмосфере нашего ретрита!</p>
        </div>
        </Zoom>
      </div>
      </>
